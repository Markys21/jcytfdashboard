      ...
      <div class="row">
        ...
        <div class="card">
          ...
          <div style="background-color: #242B3A;" class="m-5 card card-primary">
            ...
            <form id="imageUploadForm1" enctype="multipart/form-data">
            <div class="m-5 card-body">
              <div class="form-group">
                <label for="inputName">Event Name</label>
                <input type="text" id="eventname" value="" name="eventname" class="form-control" placeholder="Event Name" required minlength="3" maxlength="50">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                    ...
                    <input type="number" id="speakercontact" name="speakercontact" class="form-control" placeholder="Speakers Contact" required minlength="11" maxlength="15">
                  </div>
                  <div class="form-group">
            ...
            <div class="card-footer">
                  <input type="submit" class="btn btn-primary swalDefaultSuccess" value="Submit">
                </div>
            </form>
          </div>
