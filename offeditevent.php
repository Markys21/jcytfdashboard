      ...
      <div class="row">
        ...
        <div class="card">
          ...
          <div style="background-color: #242B3A;" class="m-5 card card-primary">
            ...
            <form id="frmeditevent1" enctype="multipart/form-data">
            <div class="m-5 card-body">
              ...
              <div class="form-group">
                    ...
                    <input type="date" value="<?php echo $row['Date']?>" id="eventdate" min="<?php echo date('Y-m-d', strtotime('+7 days')); ?>" name="eventdate" class="form-control" id="exampleInputPassword1" placeholder="Event Date" required>
                  </div>
              <div class="form-group">
                    <label for="exampleInputPassword1">Event Time</label>
                    <input type="text" value="<?php echo $row['Time']?>" id="eventtime" name="eventtime" class="form-control" id="exampleInputPassword1" placeholder="Event Time" required minlength="3" maxlength="50">
                  </div>
                  <div class="form-group">
                <label for="inputName">Attendees</label>
                <input type="text" value="<?php echo $row['attendees']?>" id="attendees" name="attendees" class="form-control" placeholder="Position" required minlength="1" maxlength="50">
              </div>
              <div class="form-group">
                <label for="inputName">Venue</label>
                <input type="text" value="<?php echo $row['Venue']?>" id="venue" name="venue" class="form-control" placeholder="Venue" required minlength="1" maxlength="50">
              </div>
              <div class="form-group">
                    <label for="exampleInputEmail1">Speakers Contact</label>
                    <input type="number" value="<?php echo $row['contact']?>" id="speakercontact" name="speakercontact" class="form-control" id="exampleInputEmail1" placeholder="Speakers Contact" required minlength="11" maxlength="15">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Speakers Email</label>
                    <input type="email" value="<?php echo $row['email']?>" id="speakeremail" name="speakeremail" class="form-control" id="exampleInputEmail1" placeholder="Speakers Email" required>
                  </div>
            ...
            <img src="../images/<?php echo $row['featuredimage']?>" width="100px" alt="" srcset="">
              ...
              <div style="width:100%">
                ...
                <input id="eventdesc" value="<?php echo $row['Description']?>" name="eventdesc" class="form-control" rows="3" placeholder="Message" required minlength="10" maxlength="200"></input>
              </div>
                      </div>
            ...
            <div class="card-footer">
                  <input type="submit" class="btn btn-primary" editeventid="<?php echo $eventid; ?> " id="btnupdateeventoff" value="Update">
                </div>
            </form>
          </div>
